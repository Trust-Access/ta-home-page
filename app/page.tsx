...
import { Shield, Users, Lock, Menu, Linkedin, Mail, Globe } from "lucide-react"
          ...
          <div className="max-w-4xl">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 max-w-3xl leading-relaxed">
                Implementamos soluções robustas de gestão de identidades e acessos. Com foco na experiência do usuário,
                eficiência operacional e redução de riscos, garantimos que sua empresa opere com segurança, controle e
                simplicidade.
              </p>

              <p className="text-lg text-gray-700 max-w-3xl leading-relaxed">
                Nossa criptografia simples e acessível oferece controle completo sobre suas informações, em qualquer
                lugar que elas se movam—mesmo quando compartilhadas fora da sua organização.
              </p>
          ...
          <div className="text-center space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center opacity-60">
              <div className="flex items-center justify-center">
                <div className="text-2xl font-bold text-gray-500">VALE</div>
              </div>
              <div className="flex items-center justify-center">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  A Trust Access facilita a adição de proteção a e-mails, arquivos, anexos e até mesmo dados fluindo
                  através de outros aplicativos SaaS – sem necessidade de novas contas. Essa proteção se estende além do
                  perímetro da sua organização para dar controle auditável mesmo depois que os dados saíram da sua rede.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-16 lg:grid-cols-2 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Seja você do setor financeiro, manufatura, educação ou saúde, a criptografia e controles de acesso da
                  Trust Access suportam até mesmo as regulamentações mais rigorosas, incluindo LGPD, GDPR, ISO 27001,
                  SOC 2, e muitas outras.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-16 lg:grid-cols-2 items-center">
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Proteja dados em movimento, seja um e-mail de entrada ou uma mensagem de saída, ou uma página de
                  sistema interno. Com a Trust Access, você pode alterar ou revogar permissões de acesso a qualquer
                  momento.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            <Card className="border-0 shadow-lg bg-white">
              <CardContent className="p-8">
                <div className="space-y-6">
                  <div className="text-2xl font-bold text-gray-400 tracking-wider">VALE</div>

                  <blockquote className="text-lg text-gray-700 leading-relaxed">
                    "Fiquei realmente impressionado com a cultura da empresa e o que vocês fazem para ajudar um cliente
                    a se integrar. Não é como qualquer outra empresa. É algo completamente diferente. Vocês realmente se
                    destacam por não fazer as coisas que todo mundo faz: Nada se perde, tudo é rápido. Tudo é realmente
                    mais rápido do que eu esperaria, com muito mais detalhes do que eu esperaria. Estou realmente
                    impressionado."
                  </blockquote>

                  <div className="pt-4">
                    <div className="font-semibold text-gray-900">Carlos Silva</div>
                    <div className="text-gray-600">Gerente de Segurança da Informação e Privacidade</div>
                    <div className="text-gray-500">Vale</div>
                  </div>
              ...
              <Card className="border-0 shadow-lg bg-white">
                <CardContent className="p-6">
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      <div className="text-xl font-bold text-blue-600">HOTMART</div>
                    </div>

                    <h4 className="text-lg font-semibold text-gray-900">
                      Hotmart Substitui Soluções Complexas pela Trust Access para Gestão Simplificada de Dados
                    </h4>

                    <blockquote className="text-gray-700">
                      "Ter uma ferramenta como a Trust Access que pudéssemos implementar rapidamente, que não exigisse
                      muito trabalho para colocar em funcionamento, foi uma vantagem."
                    </blockquote>

                    <div className="pt-2">
                      <div className="font-semibold text-gray-900">Roberto Santos</div>
                      <div className="text-gray-600">Engenheiro Sênior de Segurança</div>
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="border-0 shadow-xl">
              <CardHeader className="text-center pb-8">
                <CardTitle className="text-3xl font-bold text-blue-600 mb-4">Agendar uma Demo</CardTitle>
              </CardHeader>
                ...
                <form className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="text-sm text-gray-600">
                      Ao completar este formulário, você concorda em receber comunicações de marketing da Trust Access.
                      Você pode cancelar a inscrição a qualquer momento. Consulte nossa{" "}
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-gray-400 max-w-xs">
                Especialistas em IAM e segurança digital. Implementamos soluções robustas de gestão de identidades e
                acessos.
              </p>
